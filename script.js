...
const t = {
  ...
  he: {
    ...
    welcome_hero: ".שואל שאלות ממוקדות, משתמש בבינה מלאכותית כדי לעשות סדר בתסמינים, ושולח סיכום ברור ומתורגם עם צעדים מומלצים להמשך HART ברוכים הבאים! ספרו לנו מה קורה—‏ ",
    form_id: "מס׳ טופס",
    form_date: "תאריך",
